...
no ponto (0,0) da imagem para referência.
...
class SerialManager:
    ...
    def send(self, data_str):
        ...
        :param data_str: string formatada com coordenadas, ex: "E,10,-5\n"
        """
...
class VideoHandler:
    ...
    def _initialize_camera(self):
        ...
        # Opcional: forçar resolução 640x480 para processamento
    ...
    def _process_and_draw(self, frame_bgr):
        # Converte para HSV e aplica máscara
        ...
        if contours:
            ...
            if area > 500:
                ...
                # Converter pixels para erro centralizado (0 no centro)
        ...
        # Desenhar cruz amarela no centro (0,0 em pixels = (320,240))
        cx = VIDEO_WIDTH // 2
        cy = VIDEO_HEIGHT // 2
        ...
        # Converter para PIL ImageTk e exibir no canvas
