...
def ligar_serial():
    ...
    try:
        ...
        print(f"[INFO] Ligado à porta {porta_selecionada.get()}")
...
def desligar_serial():
    ...
    if serial_conn and serial_conn.is_open:
        serial_conn.close()
        print("[INFO] Conexão serial terminada.")
...
ctk.CTkOptionMenu(frame_pid, values=portas_disponiveis, variable=porta_selecionada, fg_color="green", button_color="green", button_hover_color="darkgreen").pack(pady=5)
