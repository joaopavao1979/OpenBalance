...
// =====================
// OpenBalance Arduino – PID com Calibração Física Incorporada
// Versão 2.1 com leitura de constantes de calibração no topo
// =====================

// === DADOS DE CALIBRAÇÃO (preencha manualmente após montagem) ===
...
const int PWM_FREQ = 50;  // 100 Hz para servos digitais
...
void setup() {
  ...
  // Período em μs de cada ciclo: 20 000 μs / PWM_FREQ
...
void loop() {
  ...
  // (opcional) acrescenta comandos de calibração ou RESET aqui
}
...
void applyPID() {
  ...
  sumErrX += errX * dt; sumErrY += errY * dt;
